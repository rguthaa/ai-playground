...
Every student has navigated the same frustrating experience: five portals to find one answer, an advisor who only meets Thursdays, a policy PDF last updated in 2019.

**University AI** is a single conversational interface for the entire university experience.

- **Students** get instant, personalized answers grounded in the university Knowledge Base
- **Admins** offload repetitive applicant questions to AI
- **Advisors** walk into appointments already informed
- **Faculty** stop answering "what's on the syllabus?" emails at 11pm

Behind every interaction is **GenOS** — a shared AI Operating System that ensures every call is traced, evaluated, and comparable. The university gets a smarter institution. The engineering team gets a world-class AI experimentation lab.

**MVP 1 scope:** Student Q&A via RAG — Maya asks a question, gets a personalized answer grounded in the university Knowledge Base, and every interaction is fully observable in Langfuse.
